...
To add the errand to your CF deployment, use this ops file: https://github.com/cloudfoundry/cf-performance-tests-pipeline/blob/main/operations/performance-tests-errand.yml
